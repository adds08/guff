...
class ThemeApp {
  ...
  static const Color green = Colors.blue;
  static const Color greenPale = Colors.lightBlue;
  ...
  static final ThemeData configTheme = ThemeData.light().copyWith(
    ...
    appBarTheme: const AppBarTheme(backgroundColor: Colors.blueAccent, foregroundColor: white),
  );
}

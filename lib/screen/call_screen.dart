        ...
        children: [
          ...
          ...dataCalls.map((e) {
            ...
            return ListTile(
              title: Text(
                e.name,
                style: const TextStyle(color: ThemeApp.black, fontWeight: FontWeight.w500),
              ),
              subtitle: Row(
                children: [
                  Transform(
              ...
              leading: CircleAvatar(radius: 20.0, backgroundImage: NetworkImage(e.avatar)),
              trailing: IconButton(
                onPressed: () {},
                icon: const Icon(Icons.call, size: 25.0, color: ThemeApp.green),
              ),
              onTap: () {},
            );
          }),
